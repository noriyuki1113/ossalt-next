# ossalt — Open Source Alternatives Catalog

SaaSやプロプライエタリ製品の代替になりうるOSSを探しやすくするために、[OpenAlternative](https://openalternative.co/) の公開 awesome-list をもとに整理したカタログです。

> Source: [piotrkulpinski/open-source-alternatives](https://github.com/piotrkulpinski/open-source-alternatives/tree/main)  
> Upstream README snapshot: `d986217149548434a540fdab6d755047fe188533`  
> Upstream last updated: September 12, 2026  
> Upstream total: 786 projects / 86 categories / 14M stars

このREADMEは**候補探索用の一覧**です。ossalt本体では、ここから候補をレビューし、移行難易度・ライセンス・セルフホスト可否・運用負担・失う機能などを確認したものだけを詳細ページへ掲載していきます。

- [ossalt Web](https://ossalt-next.vercel.app)
- [レビュー基準](docs/candidate-review.md)
- [レビュー済みデータ](data/reviewed-candidates.json)
...
この一覧は OpenAlternative の公開READMEを読みやすく再構成したスナップショットです。掲載情報の一次ソースや最新状態は各プロジェクト公式サイト・GitHub・OpenAlternative側で確認してください。

ossaltでは、この一覧をそのまま「推奨」とは扱いません。候補ごとに公式情報を確認し、移行先として現実的かをレビューしてから公開します。
